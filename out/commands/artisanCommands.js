...
exports.ArtisanCommands = void 0;
const vscode = require("vscode");
const path = require("path");
class ArtisanCommands {
    static register(context) {
        // Make Model command
        context.subscriptions.push(vscode.commands.registerCommand('laravel.makeModel', async () => {
        ...
        context.subscriptions.push(vscode.commands.registerCommand('laravel.makeController', async () => {
            const name = await vscode.window.showInputBox({
        ...
        context.subscriptions.push(vscode.commands.registerCommand('laravel.makeMigration', async () => {
            const name = await vscode.window.showInputBox({
        ...
        context.subscriptions.push(vscode.commands.registerCommand('laravel.makeRequest', async () => {
            const name = await vscode.window.showInputBox({
        ...
        context.subscriptions.push(vscode.commands.registerCommand('laravel.makeMiddleware', async () => {
            const name = await vscode.window.showInputBox({
        ...
        // Make Seeder command
        context.subscriptions.push(vscode.commands.registerCommand('laravel.makeSeeder', async () => {
            const name = await vscode.window.showInputBox({
        ...
        context.subscriptions.push(vscode.commands.registerCommand('laravel.makeFactory', async () => {
            const name = await vscode.window.showInputBox({
        ...
        // Migrate command
        context.subscriptions.push(vscode.commands.registerCommand('laravel.migrate', async () => {
            const options = await vscode.window.showQuickPick([
        ...
        context.subscriptions.push(vscode.commands.registerCommand('laravel.clearCache', async () => {
            const options = await vscode.window.showQuickPick([
        ...
        context.subscriptions.push(vscode.commands.registerCommand('laravel.customArtisan', async () => {
    ...
    static async runArtisan(command) {
...
exports.ArtisanCommands = ArtisanCommands;
